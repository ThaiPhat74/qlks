...
class MyBookingView(AuthenticatedAdmin):
    ...
    def index(self):
        ...
        return self.render('admin/booking_admin.html', rooms=room_list, booking_room=booking_room)
...
class StatsView(AuthenticatedUser):
    ...
    def index(self):
        ...
        return self.render('admin/stats.html',
                           month_stats=dao.roomType_month_stats(year=year),
                           stats=dao.RoomType_stats(kw=kw,
                                                   from_date=from_date,
                                                   to_date=to_date))
